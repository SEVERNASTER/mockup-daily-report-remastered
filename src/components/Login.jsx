            ...
            <div className="w-full max-w-[1000px] bg-white rounded-3xl shadow-2xl overflow-hidden flex animate-in fade-in zoom-in-95 duration-500 min-h-[600px]">
                ...
                <div className="hidden lg:flex w-1/2 bg-[#0f172a] p-12 flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="bg-white/5 backdrop-blur-sm p-3 rounded-2xl inline-block mb-10 border border-white/10">
                            <img
                                src="/bestLogo.png"
                                alt="BEST Logo"
                        ...
                        <h1 className="text-4xl font-extrabold text-white leading-tight mb-5">
                            The Enterprise <br />
                            <span className="text-[#4a89dc]">Reporting Hub</span>
                        </h1>
                        <p className="text-slate-300 text-lg leading-relaxed max-w-md font-medium">
                            Secure access to the Company Brain for global internal and external project tracking.
                        </p>
                    </div>
                    ...
                    <div className="relative z-10 space-y-5">
                        <div className="flex items-center gap-4 text-slate-300 bg-white/5 p-3 rounded-xl border border-white/5 w-max">
                            ...
                            <span className="text-sm font-semibold tracking-wide">Secure role-based access</span>
                        </div>
                        <div className="flex items-center gap-4 text-slate-300 bg-white/5 p-3 rounded-xl border border-white/5 w-max">
                ...
                <div className="w-full lg:w-1/2 p-8 sm:p-12 relative flex flex-col justify-center">
                    ...
                    <div className="absolute top-6 right-6 z-10">
                        <div className="relative group">
                            <select
                                ...
                                disabled={isLoading}
                                className="appearance-none bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-600 text-xs font-bold rounded-lg pl-8 pr-6 py-2 cursor-pointer outline-none transition-all shadow-sm focus:border-[#4a89dc] focus:ring-2 focus:ring-[#4a89dc]/20"
                            >
                                {languages.map((lang) => (
                                    <option key={lang} value={lang}>{lang}</option>
                                ))}
                            </select>
                            <Globe className="absolute left-2.5 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-slate-400 group-hover:text-[#4a89dc] pointer-events-none transition-colors" />
                        </div>
                    </div>
                    ...
                    <div className="max-w-sm w-full mx-auto mt-4 lg:mt-0">
                        ...
                        <div className="mb-8">
                            ...
                            <p className="text-slate-500 text-sm mt-1.5 font-medium">Sign in to access your dashboard</p>
                        </div>
